...
function processData(csv, us, country, chinese) {
  ...
  const idByName = new Map(
    us.objects.geo.geometries.map((d) => [d.properties.alpha3, d.id])
  );
  ...
  // nodes.sort((a, b) => a.chinese_name.localeCompare(b.chinese_name));
